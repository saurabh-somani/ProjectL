<%@ Page Theme="StudentTheme" Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="ProjectL.Student" %>
...
<br />
    ...
    <br />
    <asp:Button ID="LoginB" runat="server" Text="Login" OnClick="Login" />
    <br />
